...
|E| [Radioactive Islands](https://code.google.com/codejam/contest/7234486/dashboard#s=p4)| [PyPy](./World%20Finals/radioactive-islands.py) [Python](./World%20Finals/radioactive-islands2.py) [Python](./World%20Finals/radioactive-islands3.py) | _O(X/H)_ | _O(1)_ | Hard | the most interesting problem this year | DP, Integral, Calculus of Variations, Euler-Lagrange Equation, Runge-Kutta Method, Binary Search, Hill-Climbing |
