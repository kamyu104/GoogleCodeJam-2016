...
|E| [Radioactive Islands](https://code.google.com/codejam/contest/7234486/dashboard#s=p4)| [PyPy](./World%20Finals/radioactive-islands.py) [Python](./World%20Finals/radioactive-islands2.py) | _O(X/H)_ | _O(1)_ | Hard | | DP, Integral, Euler-Lagrange Equation, Runge-Kutta Method |
